...
INSERT INTO user VALUES ("admin", "Sm+RR3dlJkryPkcj3S5YWymxlzuJ43A0K6vPYHfJVOo=", 1);
*/

/* DEBUG
$j = serialize(array("name" => "admin", "isadmin" => true));
$_COOKIE["JSESSION"] = base64_encode($j . mac($j));
//$_POST["username"] = "admin";
//$_POST["password"] = "AHei9wa4nlywtio";
//*/
